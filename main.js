...
function instanciarGerente(nome,idade,cargo,departamento){                             //função que inicia o objeto do gerente
...
function instanciarDesenvolvedor(nome,idade,cargo,linguagem){                           //mesma lógica do instanciarGerente
